        ...
        return (
            <div className="about-page">
                <div className="about-page--inner">
                    ...
                    <p className="about">A skilled web developer specialising in Javascript. Delivering highly interactive and intuitive JS applications with a good footing in server side programming with Node. You can <a href="mailto:tom_dempster@hotmail.co.uk">contact me</a> or find me here:</p>
                    ...
                    <div className="tools">
                        ...
                        <div>
                            ...
                            <span className="badge badge-pill">Webpack</span>
